...
<style lang="postcss">
    ...
    .post-preview__title {
        @apply text-lg leading-tight font-semibold text-white mb-2 text-theme-primary;
    }
    .post-preview__desc {
        @apply text-base text-theme-dark-primary leading-5 line-clamp-2 text-gray-600 dark:text-gray-200;
    }
    .tag-list {
        @apply list-none py-2 flex flex-wrap gap-2;
    }
    .tag {
        @apply inline-block leading-tight font-semibold text-xs px-4 py-1 rounded-full bg-theme-primary;
    }
</style>
